...
int ux , uy , uz; //periodicty along x, y z direction
double a_constant;
...
void FN_atom_coords(){
    ...
    fn_simplecubic(sc_atom_coords); //generate sc atom coords
    fn_bcc(bcc_atom_coords); //generate bcc atom coords
    fn_fcc(fcc_atom_coords); //generate fcc atom coords
    fn_diamond_fcc(diamond_atom_coords); //generate diamonds atom coords
    return;
}
